...
const ImportMCQWord = ({ isFormValid, formData, onSuccess, selectedFolderName, collegeName, userRole,selectedTopic, selectedFolderId }) => {
  ...
  const handleUpload = async () => {
    ...
    const formDataToSend = {
      ...
      'created_by': formData.created_by || null,
       'folder_name_id': selectedFolderId ,
