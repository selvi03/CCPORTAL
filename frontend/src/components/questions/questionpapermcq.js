...
const QuestionPaperMCQ = ({ userRole, collegeName,selectedTestTypeCategoryPass: testTypeCategory,selectedSkill, onCloseModal }) => {
     const {
        setQuestionPaperCon,
        topicCon,
        subTopicCon,
...
/>
                    ...
                    {uploadType === 'Word' && (
                        <div style={{ marginLeft: '0px' }}>
                            <div style={{ height: "140px" }}>
                                <ImportMCQWord  selectedTopic={selectedTopic} isFormValid={isFormValid} formData={formData} selectedFolderName={selectedFolderName} collegeName={collegeName} onSuccess={onCloseModal}
  selectedFolderId={selectedFolderId}  userRole={userRole} />
                            </div>
                            <p style={{ height: "50px" }}></p>
                        </div>
                    )}
                ...
                <div>
                    {userRole === 'Placement Officer' ? (
                        <MCQForm onSuccess={onCloseModal} collegeName={collegeName} userRole={userRole}  selectedTopic={selectedTopic?.name}
  selectedSubtopic={selectedSubtopic?.name}
