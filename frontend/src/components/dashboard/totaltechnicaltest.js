...
import { get_test_name_group_API_TotalTechnicalTest } from '../../api/endpoints';
...
const navigate = useNavigate();
  ...
  const handleBack = () => {
    ...
    const getTestCandidates = () => {
        get_test_name_group_API_TotalTechnicalTest(
    ...
    return (
        <div className='table-testschedule'>
            <div className="product-table-container">
                <h6>Total Technical Test Report</h6>
                                ...
                                .map((item) => (
                                    <tr key={item.id} className="table-row">
                                        ...
                                        <td style={{ textAlign: "center" }}>
                                            <Link to={`/test_candidates/${item.test_name}/${item.college_id}/`}  state={{ origin: "TotalTechnicalTest" }} style={{ color: "white" }}>
                                                {item.student_count}
                                            </Link>
                                        </td>
                                        <td style={{ textAlign: 'center' }}>
                                            <Link
                                                ...
                                                state={{ origin: "TotalTechnicalTest" }}
                                                style={{ color: "white" }}
                                            >
...
export default TotalTechnicalTest;
