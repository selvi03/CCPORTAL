...
import { get_test_name_group_API_TotalcommunicationTest } from '../../api/endpoints';
...
const navigate = useNavigate();
  ...
  const handleBack = () => {
    ...
    const getTestCandidates = () => {
        get_test_name_group_API_TotalcommunicationTest(
    ...
    return (
        <div className='table-testschedule'>
            <div className="product-table-container">
                <h6>Total Communication Test Report</h6>
                                ...
                                .map((item) => (
                                    <tr key={item.id} className="table-row">
                                        ...
                                        <td style={{ textAlign: "center" }}>
                                            <Link to={`/test_candidates/${item.test_name}/${item.college_id}/`}  state={{ origin: "TotalCommunicationTest" }} style={{ color: "white" }}>
                                                {item.student_count}
                                            </Link>
                                        </td>
                                        <td style={{ textAlign: 'center' }}>
                                            <Link
                                                ...
                                                state={{ origin: "TotalCommunicationTest" }}
                                                style={{ color: "white" }}
                                            >
...
export default TotalCommunicationTest;
