...
import { get_test_name_group_API_TotalcompanyTest } from '../../api/endpoints';
...
const navigate = useNavigate();
  ...
  const handleBack = () => {
    ...
    const getTestCandidates = () => {
        get_test_name_group_API_TotalcompanyTest(
    ...
    return (
        <div className='table-testschedule'>
            <div className="product-table-container">
                <h6>Total CompanySpecific Test Report</h6>
                                ...
                                .map((item) => (
                                    <tr key={item.id} className="table-row">
                                        ...
                                        <td style={{ textAlign: "center" }}>
                                            <Link to={`/test_candidates/${item.test_name}/${item.college_id}/`} state={{ origin: "TotalCompanyTest" }}  style={{ color: "white" }}>
                                                {item.student_count}
                                            </Link>
                                        </td>
                                        <td style={{ textAlign: 'center' }}>
...
export default TotalCompanyTest;
