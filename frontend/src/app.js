...
import GenerateQuestionsForm from './components/questions/generatequestions.js';
import AutoSchedule from './components/lms/autoschedule.js';
     ...
     <Route path="/total-commun-test-report/:collegeId" element={<TotalCommuncationTest />} />
             ...
             <Route path="/question/mcq/test" element={<QuestionPaperMCQTest username={username} collegeName={collegeName} userRole={userRole} institute={institute} />} />
                      ...
                      <Route path="/question/communication/" element={<UploadCommunicationTest />} />
                       <Route path="/question/generate/" element={<GenerateQuestionsForm />} />

                                <Route path="/auto/schedule/" element={<AutoSchedule username={username} userRole={userRole}collegeName={collegeName}  />} />
